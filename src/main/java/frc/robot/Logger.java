...
/**
 * Attribution: This Logger class was forked from "Team 4915, Spartronics."
 * <p>
 * 
 * <pre>
 * Logger:
...
public class Logger  {
    ...
    public Logger(Class<?> clazz, Level lev) {
        this(clazz.getSimpleName(),lev);
    }

    public Logger(Class<?> clazz) {
        this(clazz.getSimpleName(), RobotMap.logLevel);
    }
    ...
    private void logMsg(String lvl, String msg) {
        ...
        System.out.println(nowstr + " " + lvl + " " + m_namespace + ": " + msg + "\r"); // We need \r because National
                                                                                        // Instruments likes to compress
                                                                                        // frequent messages without the
                                                                                        // carriage return
    }
